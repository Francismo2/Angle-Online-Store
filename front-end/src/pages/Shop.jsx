...
const Shop = () => {
  ...
  const filteringProducts = () => {
    ...
    if (selectedFilter !== 'All' && selectedFilter !== 'Filter') {
      if (selectedFilter === 'Best Sellers') {
        updatedProducts = updatedProducts.filter(item => item.is_bestseller === true);
      } else {
        updatedProducts = updatedProducts.filter(item => item.category_name === selectedFilter);
      }
    }
  ...
  const sortProduct = () => {
    ...
    if (sortType === "low-high") {
      ...
      setFilteredProducts(fpCopy.sort((a, b) => (a.product_name.localeCompare(b.product_name))));
    }
    else if (sortType === "z-a") {
      setFilteredProducts(fpCopy.sort((a, b) => (b.product_name.localeCompare(a.product_name)))); 
    }
    else {
